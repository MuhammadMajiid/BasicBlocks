...
create_clock -period 20.000 -name sys_clk_pin -waveform {0.000 4.000} -add [get_ports {clk}]
##Switches
set_property -dict {PACKAGE_PIN G15 IOSTANDARD LVCMOS33} [get_ports {rst_n}];
#set_property -dict {PACKAGE_PIN P15 IOSTANDARD LVCMOS33} [get_ports {effect[1]}]
...
set_property -dict {PACKAGE_PIN P16 IOSTANDARD LVCMOS33} [get_ports {in}]
#set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L10P_T1_AD11P_35 Sch=btn[2]
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L7P_T1_34 Sch=btn[3]
##LEDs
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports {out} ]
...
# #  UART 1 / tx / MIO[48]
#set_property -dict { PACKAGE_PIN B12   IOSTANDARD LVCMOS18 } [get_ports {tx}];
# set_property PACKAGE_PIN "B12" [get_ports {tx}];
# set_property slew "slow" [get_ports {tx}];
# set_property drive "8" [get_ports {tx}];
# set_property PIO_DIRECTION "OUTPUT" [get_ports {tx}];
